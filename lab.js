...
if (temperature >= 80 && rain) {
  console.log('Wear a t-shirt and grab an umbrella my good man')
} else if (temperature > 60 && rain) {
  console.log('Better throw on a rain-jacket there pal')
} else if (temperature <= 60 && rain) {
  console.log(`Throw on a jacket and grab an umbrella 'cause we're gettin' soggy today, boys`)
} else if (temperature >= 80 && !rain) {
  console.log('Break out the spaghetti straps and shorts for hot girl summer')
} else if (temperature > 60 && !rain) {
  console.log('Perfect weather for a tee and jeans')
} else if (temperature <= 60 && !rain) {
  console.log(`Make sure to grab a jacket and wear pants today, unless you're Tyler from PE class because I know you'll wear your basketball shorts no matter what I say`)
}
...
//After you change the value of changeMyMind, console.log its new value (it should now read true).
